...
export default function PaymentModal({ course, onClose }: PaymentModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-2 md:p-4">
      <div className="cyber-border bg-cyber-surface rounded-xl max-w-4xl w-full max-h-[95vh] md:max-h-[90vh] overflow-auto cyber-glow relative mx-2 md:mx-0">
        ...
        <div className="p-6">
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="text-center space-y-4 md:space-y-6">
              ...
              <div className="bg-white p-4 md:p-6 rounded-xl inline-block border border-cyber-border">
                <img 
                  src={qrCodeImage} 
                  alt="Payment QR Code" 
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="w-full p-3 bg-gray-900 border border-cyan-500/50 rounded-lg text-white placeholder-gray-400 focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500"
