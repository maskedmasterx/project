  ...
  const testimonials = [
    {
      ...
      content:
        "CyberSec Academy transformed my career. The hands-on approach and real-world scenarios prepared me for actual penetration testing challenges. Highly recommended!",
    },
    {
      name: "Priya Sharma",
      ...
      content:
        "The quality of courses at such affordable prices is incredible. I landed my dream job in cybersecurity within 3 months of completing the ethical hacking course.",
    },
    {
      name: "Rohit Kumar",
      ...
      content:
        "Outstanding curriculum and expert instructors. The courses are regularly updated with latest security trends. Best investment for cybersecurity professionals.",
    },
    {
      name: "Sneha Gupta",
      ...
      content:
        "The digital forensics course exceeded my expectations. Practical labs and industry-relevant content made learning engaging and effective.",
    },
  ];
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
              Democratizing Elite Cybersecurity Education for the Next
              Generation of Ethical Hackers
            </p>

            <div className="cyber-border bg-cyber-surface/50 p-8 rounded-xl mb-12">
              <h2 className="text-2xl terminal-font font-bold text-primary mb-4">
                Our Mission
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                At CyberSec Academy, we believe that high-quality cybersecurity
                education should be accessible to everyone. We bridge the gap
                between expensive premium courses and affordable learning by
                offering industry-leading content at fraction of the cost,
                enabling aspiring cybersecurity professionals to build
                successful careers without financial barriers.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="cyber-border bg-cyber-surface/50 p-8 rounded-xl">
                <h3 className="text-2xl font-bold text-primary mb-4 terminal-font">
                  The Problem
                </h3>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Quality cybersecurity education was locked behind expensive
                  paywalls, with courses costing ₹15,000-₹50,000+. Talented
                  individuals were unable to access world-class training due to
                  financial constraints, creating barriers to entering the
                  cybersecurity field.
                </p>

                <h3 className="text-2xl font-bold text-cyan-500 mb-4 terminal-font">
                  The Solution
                </h3>
                <p className="text-muted-foreground leading-relaxed">
                  We invest in premium courses from leading platforms and
                  redistribute them at 90% discounts, making elite cybersecurity
                  education accessible to everyone. Our sustainable model helps
              ...
              <div className="space-y-6">
                <div className="cyber-border bg-cyber-dark p-6 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Cutting-edge curriculum updated with latest security trends
                    and threats
                  </p>
                </div>
                ...
                <div className="cyber-border bg-cyber-dark p-6 rounded-xl">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Promoting responsible hacking and ethical cybersecurity
                    practices
                  </p>
                </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="cyber-border bg-cyber-surface/50 p-12 rounded-xl max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8 text-lg">
              Join thousands of successful cybersecurity professionals who
