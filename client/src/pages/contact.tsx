...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "We'll get back to you within 24 hours. Check your WhatsApp for quick responses.",
      });
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      title: "Phone",
      value: "+91 XXXXXXXXXX",
      description: "This service avaavailable soon ",
      action: () => window.open("tel:+910000000000", "_blank"),
      color: "text-cyan-500",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Course access is provided within 24 hours after payment verification and UTR submission.",
    },
    {
      question: "Are courses updated regularly?",
      answer:
        "Yes, all courses are updated quarterly with latest cybersecurity trends and tools.",
    },
    {
      question: "Do you provide certificates?",
      answer:
        "Yes, completion certificates are provided for all courses upon finishing the curriculum.",
    },
    {
      question: "Can I get a refund?",
      answer:
        "All sales are final. Please check our Terms & Conditions for detailed refund policy.",
    },
  ];
            ...
            <div className="cyber-border bg-cyber-surface/50 p-8 rounded-xl mb-12">
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-lg font-bold text-primary terminal-font">
                    &lt; 2 Hours
                  </div>
                </div>
                <div className="text-center">
                  ...
                  <div className="text-lg font-bold text-cyan-500 terminal-font">
                    24/7
                  </div>
                </div>
                <div className="text-center">
                  ...
                  <div className="text-lg font-bold text-pink-500 terminal-font">
                    Hindi & English
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            {contactMethods.map((method, index) => (
              ...
              >
                <method.icon
                  className={`w-12 h-12 ${method.color} mx-auto mb-4`}
                />
                ...
                <Button className="mt-4 bg-gradient-to-r from-primary to-cyan-500 text-primary-foreground px-6 py-2 rounded-lg font-bold hover:from-cyan-500 hover:to-primary transition-all duration-300">
                  Connect Now
                </Button>
              </div>
            ))}
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="cyber-border bg-cyber-surface/50 p-8 rounded-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <Label className="text-sm terminal-font text-foreground">
                      Full Name *
                    </Label>
                    <Input
                      type="text"
              ...
              <div className="space-y-8">
                ...
                <div className="cyber-border bg-cyber-dark p-6 rounded-xl">
                  <h3 className="text-xl terminal-font font-bold text-primary mb-4">
                    Contact Information
                  </h3>
                ...
                {/* Quick Links */}
                <div className="cyber-border bg-cyber-dark p-6 rounded-xl">
                  <h3 className="text-xl terminal-font font-bold text-cyan-500 mb-4">
                    Quick Actions
                  </h3>
                  <div className="space-y-3">
                    ...
                    <Button
                      onClick={() => {
                        playSound("click");
                        window.open(
                          "https://wa.me/918302718516?text=Hi! I need help with course selection.",
                          "_blank",
                        );
                      }}
                      variant="outline"
                ...
                {/* FAQ */}
                <div className="cyber-border bg-cyber-dark p-6 rounded-xl">
                  <h3 className="text-xl terminal-font font-bold text-yellow-500 mb-4">
                    Frequently Asked
                  </h3>
                  <div className="space-y-4">
                    {faqs.map((faq, index) => (
                      <div
                        key={index}
                        className="border-b border-cyber-border/50 pb-3 last:border-b-0"
                      >
          ...
          <div className="cyber-border bg-cyber-surface/50 p-12 rounded-xl max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="text-2xl font-bold text-cyan-500 terminal-font mb-2">
                  9:00 AM - 9:00 PM
                </div>
                <div className="text-muted-foreground">
                  Monday to Sunday (IST)
                </div>
              </div>
              <div>
                <h3 className="text-xl font-bold text-foreground mb-4">
                ...
                <div className="text-2xl font-bold text-green-500 terminal-font mb-2">
                  24/7 Available
                </div>
